---
title: "向量检索技术指南 | Datalayers 文档"
description: "Datalayers 向量检索技术指南 - 向量检索是一种针对非结构化数据的高效近似搜索技术。该技术将文档、图像、音频、视频等非结构化数据转换为向量嵌入（Vector Embedding）存储在数据库中，通过计算向量间的相似度来实现数据检索。"
---
# 向量检索技术指南
