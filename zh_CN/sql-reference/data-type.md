---
title: "数据类型参考手册 | Datalayers 文档"
description: "Datalayers SQL 提供丰富的数据类型系统，支持数值、时间、布尔、字符串和向量等多种数据格式。每种类型都有明确的存储格式和取值范围，可根据业务需求选择合适的数据类型。"
---
# 数据类型参考手册
...
| Name | Description |
| --- | --- |
| TIMESTAMP | Int64、Timestamp(precision)，可选值为 0、3、6、9，分别代表秒、毫秒、微秒、纳秒；缺省值：毫秒 |
