---
title: "LIMIT 语句参考指南 | Datalayers 文档"
description: "Datalayers LIMIT 语句参考指南 - LIMIT 子句是 SQL 中用于控制查询结果集大小的关键语句，它通过限制返回的记录数量来优化查询性能和资源使用。结合 OFFSET 子句可以实现分页功能，是处理大数据集的重要工具。"
---
# LIMIT 语句参考指南
