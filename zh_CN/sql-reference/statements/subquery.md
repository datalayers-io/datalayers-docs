---
title: "Subquery 语句详解 | Datalayers 文档"
description: "Datalayers Subquery 语句详解 - 子查询（Subquery）是 SQL 中嵌套在其他查询内部的查询，允许将一个查询的结果作为另一个查询的条件、列或数据源。子查询提供了强大的数据关联和分析能力，是复杂查询的核心工具。"
---
# Subquery 语句详解
