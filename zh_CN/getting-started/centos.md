...
<a href="https://docs.datalayers.cn/public/centos/datalayers-1.0.1-1.el7.x86_64.rpm" download="datalayers-1.0.1-1.el7.x86_64.rpm">点击下载</a>rpm安装包。
...
``` bash
sudo yum localinstall ./datalayers-1.0.1-1.el7.x86_64.rpm
```
