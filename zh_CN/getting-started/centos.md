...
<a href="https://docs.datalayers.cn/public/centos/datalayers-2.1.6-1.el7.x86_64.rpm" download="datalayers-2.1.6-1.el7.x86_64.rpm">点击下载</a>rpm安装包。
...
``` bash
sudo yum localinstall ./datalayers-2.1.6-1.el7.x86_64.rpm
```
