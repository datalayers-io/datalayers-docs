---
title: "Prometheus 协议兼容 | Datalayers 文档"
description: "Datalayers 兼容 Prometheus 的远程写入协议（Remote Write Protocol） 与 PromQL（Prometheus Query Language）查询语言，支持与 Prometheus 原生生态工具的无缝集成。"
---
# Prometheus 协议兼容
