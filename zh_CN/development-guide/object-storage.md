---
title: "Datalayers 对象存储配置指南"
description: "介绍 Datalayers 对象存储接入方式、存算分离架构优势和 S3 兼容配置方法，帮助你完成弹性扩展与成本优化。"
---
# Datalayers 对象存储配置指南
...
- 了解连接与接入方式，请参考 [Datalayers 数据库连接指南](./connection.md)
- 了解数据缓存优化，请参考 [Datalayers 数据缓存优化指南](./query-optimization/hybrid-cache-optimization.md)
