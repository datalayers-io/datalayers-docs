---
title: "对象存储 | Datalayers 文档"
description: "Datalayers 采用存算分离架构，将计算层和存储层完全解耦，使得能够根据业务需求独立扩展计算和存储资源。这种架构不仅避免了资源浪费，优化了成本效益，同时显著提升了系统的整体性能、安全性和可维护性。因此，在具备对象存储服务的条件下，我们推荐用户优先选择 存算分离 的部署方案。"
---
# 对象存储
