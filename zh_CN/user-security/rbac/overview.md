---
title: "Datalayers 访问控制概述"
description: "介绍 Datalayers 基于用户、权限和角色的访问控制模型，帮助你理解 RBAC 权限体系与数据库安全管理方式。"
---
# Datalayers 访问控制概述

访问控制是数据库安全体系的核心能力，用于管理用户连接权限和数据操作权限。Datalayers 采用基于用户、权限和角色的访问控制模型，实现对数据库资源的精细化授权与隔离。
...
- 了解用户定义与管理，请参考 [用户管理](./user.md)
- 了解角色定义与授权，请参考 [角色管理](./role.md)
- 了解权限粒度与授权方式，请参考 [权限管理](./privilege.md)
